...
namespace MedioClinic.Controllers
{
    public class DoctorsController : BaseController
    {
        ...
        public DoctorsController(IBusinessDependencies dependencies, IDoctorRepository doctorRepository, IDoctorSectionRepository doctorSectionRepository) : base(dependencies)
        {
